  ...
  const [listItems] = useState([
    {
      ...
      fiatCurrencyName: 'Pound Sterling',
      flagIcon: 'GBP',
      fiatSymbolIcon: 'icon fiat-currency-symbols-GBP',
    },
    {
      fiatCurrencyCode: 'USD',
      fiatCurrencyName: 'US Dollar',
      flagIcon: 'USD',
      fiatSymbolIcon: 'icon fiat-currency-symbols-USD',
    },
    {
      fiatCurrencyCode: 'CNY',
      fiatCurrencyName: 'Yuan',
      flagIcon: 'CNY',
      fiatSymbolIcon: 'icon fiat-currency-symbols-CNY',
    },
    {
      fiatCurrencyCode: 'EUR',
      fiatCurrencyName: 'EUR',
      flagIcon: 'EUR',
      fiatSymbolIcon: 'icon fiat-currency-symbols-EUR',
    },
    {
      fiatCurrencyCode: 'RUB',
      fiatCurrencyName: 'Rubel',
      flagIcon: 'RUB',
      fiatSymbolIcon: 'icon fiat-currency-symbols-RUB',
    },
    {
      fiatCurrencyCode: 'JPY',
      fiatCurrencyName: 'Yen',
      flagIcon: 'JPY',
      fiatSymbolIcon: 'icon fiat-currency-symbols-JPY',
    },
    {
      fiatCurrencyCode: 'ZAR',
      fiatCurrencyName: 'Rand',
      flagIcon: 'ZAR',
      fiatSymbolIcon: 'icon fiat-currency-symbols-ZAR',
    },
  ])
